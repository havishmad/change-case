#change-case add-in
What it does:
Allows you to change to Upper and Lower Case without using formulas.

Benefit:
Saves a lot of time as changing case in Excel is easy to do - but time-consuming.
...
Select ChangeCase_HavishMConsulting and Press Okay
...
Tool remains visible on the screena and you can continue to work on Excel.
You can even switch to another Excel file.

a
Will work on multiple cells, rows and columns.
b
Does not work on non-contiguous cells.
For example you cannot select A1:A3 and A5:A10.
c
